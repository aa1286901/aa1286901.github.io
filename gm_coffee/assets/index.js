  ...
  state: 
  {
    items: [
      ...
      },
      {
        ...
        title: "Раф",
        description:
          "Раф - это кофейный напиток, состоящий из эспрессо, горячего молока и сладкого сиропа (обычно ванильного), украшенный нежной молочной пенкой и шоколадной крошкой или какао. \n\nВ отличие от латте, раф имеет более сладкий и мягкий вкус, благодаря добавлению сиропа. Эспрессо в рафе придает напитку интенсивный кофейный вкус, но он смягчается молоком и сиропом, что делает напиток более сладким и ароматным. Молочная пена на поверхности рафа создает дополнительную утонченность и кремовость, что делает его еще более приятным во всех отношениях.\n\nВкус рафа характеризуется сочетанием кофейного, сливочного и сладкого вкусов, что делает его отличным выбором для любителей более сладких и кремовых напитков. Раф обычно пьют вечером или после обеда, чтобы насладиться его нежным и уютным вкусом.",
